...
<html>
  <head>
    <title>WYZORD CLI - Codex Authorization Successful</title>
    <style>
      body {
        font-family:
          system-ui,
  ...
  <body>
    <div class="container">
      ...
      <p>You can close this window and return to WYZORD CLI.</p>
    </div>
    <script>
...
<html>
  <head>
    <title>WYZORD CLI - Codex Authorization Failed</title>
    <style>
      body {
        font-family:
          system-ui,
