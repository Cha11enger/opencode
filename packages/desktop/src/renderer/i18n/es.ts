export const dict = {
  ...
  "desktop.updater.none.message": "Ya estás usando la versión más reciente de WYZORD",
  ...
  "desktop.updater.downloaded.prompt":
    "Se ha descargado la versión {{version}} de WYZORD. ¿Quieres instalarla y reiniciar?",
